...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct  6 15:34:29 2020
...
class Hand:
    ...
    def remove_card(self, card):
        if card in self.init_cards:
            return self.init_cards.pop(card)
        else:
            return None
        ...
        -------
        the card, 
        or None if the card was not in the Hand
    ...
    def draw(self, deck):
        ...
        side effect: the deck will be deleted by one card
